...
class HubWebTest {
    ...
    fun aHubEditSurvivesAMergeWithAPeerThatNeverSawIt() {
        ...
        val stalePeer = ConfigJson.toJson(store.load().copy(sources = emptyList(), sync = io.yosemitekids.app.data.SyncMeta.EMPTY))
    ...
    fun aTogglePatchedFromTheBrowserIsStampedAndSurvivesAMerge() {
        ...
        val stale = ConfigJson.toJson(after.copy(sponsorSkip = true, sync = io.yosemitekids.app.data.SyncMeta.EMPTY))
