...
[ "$kid_routes" = "/ /channel /claim /home /kid-icon /kid-manifest.webmanifest /kid-tokens.css /media /progress /search /thumb /whoami /you " ] ||
  guard_fail "the kid origin serves [$kid_routes] and guard 57 expects [/ /channel /claim /home /kid-icon /kid-manifest.webmanifest /kid-tokens.css /media /progress /search /thumb /whoami /you ]. Adding one is a decision: it must fail closed to the code prompt (guard 60), get a row in docs/LAN-API.md's kid section, and be named here."
