---
name: pickwick-lan-api
description: Reference and safe-probing rules for Pickwick's phone-to-device LAN HTTP API (LanServer/LanClient in data/Pairing.kt). Use when adding a route, debugging sync/pairing, or testing a device over the network.
---

# Pickwick LAN API

Full route table: `docs/LAN-API.md`. Code: `app/src/main/java/io/pickwick/app/data/Pairing.kt`
