...
| 57 | The kid's page and the parents' console are two ORIGINS, not two paths. | `hub/src/main/kotlin/io/yosemitekids/hub/HubServer.kt`, `hub/src/main/kotlin/io/yosemitekids/hub/HubKidServer.kt`, `docs/LAN-API.md`, `hub/docker-compose.yml`, `hub/src/main/kotlin/io/yosemitekids/hub/Main.kt`, `hub/src/main`, `hub/src/main/kotlin/io/yosemitekids/hub/HubTokens.kt` | yes |
| 58 | Neither origin ever tells a browser it may read the other. | `hub/src/main` | yes |
| 59 | A child's wrong code cannot lock their parent out. | - | yes |
