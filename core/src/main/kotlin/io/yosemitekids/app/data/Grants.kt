 ...
 *
 * Deliberately calendar-free: a grant counts on the day it *names*, compared
 * as text, and the day itself is minted by [FamilyDay] so every bucket in the
 * app is spelled the same way. Nothing here reaches for `java.time`, and
 * guard 43 keeps it that way.
 */
object Grants {
